...
func NewProduct(productRepository repository.Product) *product {
	return &product{
...
func (p *product) SearchProducts(w http.ResponseWriter, r *http.Request) {
...
func (p *product) SaveProduct(w http.ResponseWriter, r *http.Request) {
